...
var packageUser_pages_order_useForm = require("./use-form.js");
var packageUser_pages_order_useMedia = require("./use-media.js");
var packageUser_pages_order_usePopup = require("./use-popup.js");
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  setup(__props) {
    const { popupRef, popup, showMessage } = packageUser_pages_order_usePopup.usePopup();
    const { formList, forms, iconClick, submit, checkForm } = packageUser_pages_order_useForm.useForm(showMessage);
    const { ichooseMedia, ipreviewMedia, idelMedia } = packageUser_pages_order_useMedia.useMedia(forms);
    return (_ctx, _cache) => {
      return {
        ...
        j: common_vendor.sr(popupRef, "151ee492-3", {
          "k": "popupRef"
        }),
        k: common_vendor.p({
          type: "message"
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-151ee492"], ["__file", "D:/workspace/Uniapp/project/iGreen/package-user/pages/order/index.vue"]]);
